...
var placeBet = function() {
  ...
  var Card = function (suit, number){
      /** Create deck of 52 cards (Suit, value, face cards etc.) */
      this.getNumber = function (){
          return number;
      };
      /**The name of the suit. "Hearts","Clubs","Spades", or "Diamonds." */
      ...
      /** HTML-encoded symbol of the suit. */
  ...
  (function (){
   ...
   var updateUI = function (){
       ...
       /* Score */
       $score.find(".digits").html(playerHand.score());
       $("#wins").text(wins);
       $("#losses").text(losses);
   };
